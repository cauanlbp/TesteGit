...
def cadastro():
    ...
    def salvar_json():
        ...
        if codigo_produto and nome_produto and valor_unitario and quantidade and imposto:
            ...
            nome_do_arquivo = "C:\\Users\\cauan\\OneDrive\\Área de Trabalho\\json\\dados.json"

            with open(nome_do_arquivo, 'w') as arquivo:
                json.dump(dados_json, arquivo)

            messagebox.showinfo("Sucesso", "Salvou o json!")
        else:
    ...
    btn_salvar = ctk.CTkButton(master=frame_cadastro, text="Salvar", width=100, command=salvar_json, height=70, fg_color=azul,corner_radius=20,text_color="white",font=("Arial Bold",18))
